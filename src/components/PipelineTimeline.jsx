...
export function PipelineTimeline({ mode = 'full', size = 'xl', showLabels = false, showPhase = true } = {}) {
  ...
  const s = {
    ...
    trackBg: {
      ...
      backgroundImage: `radial-gradient(circle, transparent 0px, transparent 1.5px, ${isLight ? 'rgba(0,0,0,0.18)' : 'rgba(255,255,255,0.18)'} 1.5px, ${isLight ? 'rgba(0,0,0,0.18)' : 'rgba(255,255,255,0.18)'} 2px, transparent 2px)`,
